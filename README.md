...
5. Experiment with the **`📊 Tree Size (100 / 500 / 1000 Nodes)`**, **`🔥 Layout delay (Phase 2)`**, and **`🎨 Draw load (+500 / +1500 DisplayList Layers)`** toggles to see real-time process isolation and phase-specific profiling in action!
